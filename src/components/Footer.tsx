      ...
      <Grid container spacing={2} justifyContent='center'>
        <Grid item md={6} lg={4}>
          ...
          <Typography variant='caption' sx={{ mt: 4 }}>
            «qzEro-Market» is an e-commerce web application mockup created by
            Roman Kuzero. This is a front-end project built using technologies
            such as TypeScript, React&Redux, MUI, etc. More information is
            available on github.
          </Typography>
          <Box
            sx={{
